...
//   If you have a total of 80 records and you want to view a page that starts from   record number 71 onwards, then yes, you would need to skip the first 70 records.

// In the context of pagination, the skip value is used to determine the starting point for fetching records. If you are displaying, for example, 10 records per page, and you are on page 8, then you would skip the first 70 records (7 pages * 10 records/page) to get to the records that should be displayed on the current page.

// Here's a quick calculation:

// javascript
// Copy code
// const page = 8; // Current page number
// const limit = 10; // Records per page

// const skip = (page - 1) * limit;
// // skip = (8 - 1) * 10 = 7 * 10 = 70
// console.log(skip); // Output: 70
// So, in this example, a skip value of 70 means you need to skip the first 70 records to display the relevant records for page 8.
